...
class TerminalTests(unittest.TestCase):
    ...
    def test_sample_request_01_and_request_25_lookup(self) -> None:
        self.assertIn("Recommendation for request_01", self.sample.recommendation("request_01"))
        self.assertIn("Recommendation for request_25", self.sample.recommendation("request_25"))
    ...
    def test_official_request_26_69_and_final_lookup(self) -> None:
        for request_id in ("request_26", "request_69", "request_275"):
            with self.subTest(request_id=request_id):
                self.assertIn(f"Recommendation for {request_id}", self.official.recommendation(request_id))
    ...
    def test_sample_comparison_is_display_only(self) -> None:
        ...
        self.assertIn("SAMPLE EXPECTED RESULT", text)
    ...
    def test_consecutive_sample_requests_are_independent(self) -> None:
        ...
        self.assertNotIn("request_id: request_01", texts[1])
    ...
    def test_runner_accepts_request_ids_and_exit_without_chat_prompts(self) -> None:
        ...
        self.assertTrue(any("Recommendation for request_01" in item for item in output))
